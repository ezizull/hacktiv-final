...
import (
	book "hacktiv/final-project/domain/book"
...
func (_m *BookTesting) GetAll(page int64, limit int64) (*book.PaginationResultBook, error) {
	ret := _m.Called(page, limit)

	var r0 *book.PaginationResultBook
	var r1 error
	if rf, ok := ret.Get(0).(func(int64, int64) (*book.PaginationResultBook, error)); ok {
		return rf(page, limit)
	}
	if rf, ok := ret.Get(0).(func(int64, int64) *book.PaginationResultBook); ok {
		r0 = rf(page, limit)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*book.PaginationResultBook)
		}
	}
...
func (_m *BookTesting) UserGetAll(page int64, userId int, limit int64) (*book.PaginationResultBook, error) {
	ret := _m.Called(page, userId, limit)

	var r0 *book.PaginationResultBook
	var r1 error
	if rf, ok := ret.Get(0).(func(int64, int, int64) (*book.PaginationResultBook, error)); ok {
		return rf(page, userId, limit)
	}
	if rf, ok := ret.Get(0).(func(int64, int, int64) *book.PaginationResultBook); ok {
